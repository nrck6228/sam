import { financialReportData } from '/js/data/data.js';
...
const engine = initListEngine({
    ...
    paginationId: 'financial-pagination',
    urlPath: '/about/financial-statements/page',
    renderTemplate: (item) => {
        // --- 1. เงื่อนไขรูป Cover Default ---
        const displayImg = item.imageUrl || '/media/images/financial/default-thumb.svg';
